...
public class BookingHistoryService {
    ...
    public Booking createBookingFromConfirmedRequest(String requestId, String customerName, String customerEmail,
        ...
        // Use the full constructor that matches your merged Booking model
        // Parameters: bookingId, requestId, customerName, customerEmail, movieId, movieTitle,
        //             showtimeId, showtimeDate, showtimeTime, cinemaHall, seats, totalPrice, confirmedAt, status
        return new Booking(
                bookingId,           // bookingId
                requestId,           // requestId
                customerName,        // customerName
                customerEmail,       // customerEmail
                null,                // movieId (not available in this context)
                movieTitle,          // movieTitle
                null,                // showtimeId (not available)
                showtimeDate,        // showtimeDate
                showtimeTime,        // showtimeTime
                cinemaHall,          // cinemaHall
                seats,               // seats
                totalPrice,          // totalPrice
                LocalDateTime.now().toString(),  // confirmedAt
    ...
    private Booking parseBooking(String line) {
        ...
        try {
            // Updated to match the merged Booking constructor
            return new Booking(
                    parts[0],  // bookingId
                    parts[1],  // requestId
                    parts[2],  // customerName
                    parts[3],  // customerEmail
                    null,      // movieId (not stored in file)
                    parts[4],  // movieTitle
                    null,      // showtimeId (not stored)
